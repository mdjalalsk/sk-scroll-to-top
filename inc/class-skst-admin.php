...
class SKST_Admin {
	...
	private function init_hooks() {
		...
		add_action( 'admin_post_skst_save_general_settings', array( $this, 'skst_save_general_settings' ) );
	}
	...
	private function includes() {
		add_action( 'wp_enqueue_scripts', array( $this, 'skst_enqueue_frontend_assets' ) );
		add_action( 'admin_enqueue_scripts', array( $this, 'skst_enqueue_admin_assets' ) );
	}
	 ...
	 * @since 1.0.0
	 */
	public function skst_scroll_to_top_render() {
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input type="number" name="button_position_y" id="button_position_y" min="1" value="<?php echo esc_attr( $button_position_y ); ?>"/>
	 ...
	 * @since 1.0.0
	 */
	public function skst_save_general_settings() {
	...
	public function skst_enqueue_admin_assets( $hook ) {
		if ( 'toplevel_page_sk-scroll-to-top' === $hook ) {
			...
			wp_enqueue_script( 'skst-admin-js', SKST_PLUGIN_URL . 'assets/js/admin.js', array( 'jquery' ), $this->version, array( 'in_footer' => true ) );
		}
	}
}
